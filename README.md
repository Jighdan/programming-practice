...
- [Numbers](https://github.com/Jighdan/python-projects#numbers)
- [Classic Algorithms](https://github.com/Jighdan/python-projects#classic-algorithms)
- [Graph](https://github.com/Jighdan/python-projects#graph)
- [Data Structures](https://github.com/Jighdan/python-projects#data-structures)
- [Text](https://github.com/Jighdan/python-projects#text)
- [Networking](https://github.com/Jighdan/python-projects#networking)
- [Classes](https://github.com/Jighdan/python-projects#classes)
- [Threading](https://github.com/Jighdan/python-projects#threading)
- [Web](https://github.com/Jighdan/python-projects#web)
- [Files](https://github.com/Jighdan/python-projects#files)
- [Databases](https://github.com/Jighdan/python-projects#databases)
- [Graphics and Multimedia](https://github.com/Jighdan/python-projects#graphics-and-multimedia)
- [Security](https://github.com/Jighdan/python-projects#security)
...
[**Count Vowels**](https://github.com/Jighdan/python-projects/text/countVowels) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

**Check if Palindrome** - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/Jighdan/python-projects/text/countWords) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
